  ...
  <section>
    ...
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $stmt = $connection->prepare("INSERT INTO Client (client_id, name, email, age, occupation) VALUES (?, ?, ?, ?, ?)");
          $stmt->bind_param("issss", $client_id, $name, $email, $age, $occupation);
    ...
    <?php
      ...
      // SQL query to fetch data from the Client
      $result = $connection->query($sql);
    ?>

    <h2>Table of Client</h2>
    <table border="5">
      <tr>
        <th>client_id</th>
        <th>name</th>
