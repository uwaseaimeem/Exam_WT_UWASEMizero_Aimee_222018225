...
<style>
  body {
    ...
    background: url('./images/d.jpg') center/cover no-repeat; /* Corrected syntax */
...
<div class="overlay">
  <div class="container">
    <h1>Welcome to Our Virtual Therapy Dog Session Platform</h1>
    <p>Feel the love and comfort of therapy dogs through our engaging sessions. Ideal for improving mental health and providing emotional relief.</p>
